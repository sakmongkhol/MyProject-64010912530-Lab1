					...
					<div class="col-lg-12 text-right">
						...
						<nav class="navbar">
							<ul class="navbar_menu">
								...
								<li><a href="contact.php">เกี่ยวกับเรา</a></li>							</ul>
		...
		<div class="row">
			<div class="col product_section clearfix">
				...
				<div class="breadcrumbs d-flex flex-row align-items-center">
					<ul>
						<li><a href="index2.php">หน้าแรก</a></li>
						<li class="active"><a href="Pellet food.php"><i class="fa fa-angle-right" aria-hidden="true"></i>อาหารเม็ด</a></li>
					</ul>
				</div>
				...
				<div class="sidebar">
					<div class="sidebar_section">
						...
						<ul class="sidebar_categories">
							<li class="active"><a href="Pellet food.php"><span><i class="fa fa-angle-double-right" aria-hidden="true"></i></span>อาหารเม็ด</a></li>
							<li ><a href="Wet food.php">อาหารเปียก</a></li>
							<li><a href="#"></a></li>
							<li><a href="#"></a></li>
							<li><a href="#"></a></li>
									...
									<div class="pages d-flex flex-row align-items-center">
										<div class="page_current">
											...
											<ul class="page_selection">
												<li><a href="Pellet food.php">1</a></li>
												<!-- <li><a href="Pellet food 1.php">2</a></li> -->
											</ul>
										</div>
										<!-- <div class="page_total"><span>of</span> 2</div> -->
										<!-- <div id="next_page" class="page_next"><a href="Pellet food 1.php"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></a></div> -->
									</div>
    ...
    ?>
								...
								<div class="product_sorting_container product_sorting_container_bottom clearfix">
									<div class="pages d-flex flex-row align-items-center">
										...
										<!-- <div class="page_total"><span>of</span> 2</div>
										<div id="next_page_1" class="page_next"><a href="Pellet food 1.html"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></a></div> -->
									</div>
