...
error_reporting(E_NOTICE);
	...
	if(isset($_GET['id'])) {
		...
		$_SESSION['stpye'][$id] = $data['p_type'];
		$_SESSION['simg'][$id] = $data['p_img'];
		@$_SESSION['sitem'][$id]++;
	}
?>
...
<blockquote>
<h2>ตะกร้าสินค้า</h2>
<a href="Pellet food.php" class="btn btn-primary">กลับไปเลือกสินค้า</a>  
...
?>
	<tr>
		<td><?=$i;?></td>
		<td><img src="images/<?=$_SESSION['sid'][$pid];?>.<?=$_SESSION['simg'][$pid];?>" width="120"></td>
